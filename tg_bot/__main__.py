...
Hello {} Me madeconespoxs is {}! - I am pro group manager bot . 

I can help you to manage your groups easily and fastly. Coded With Python.
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="➕ Add me ➕", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="Developer", url="https://t.me/conespoxs")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/GroupWorkersupport"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/GroupWorkers")],
                     [InlineKeyboardButton(text="Google", url="https://google.com"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
