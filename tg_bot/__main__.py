            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="➕ Add me ➕", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Create own Bot", url="https://youtu.be/nJqnJY4_z9Q")],
                     ...
                     [InlineKeyboardButton(text="🎬 Youtube Channel", url="https://youtube.com/channel/conespixs"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
